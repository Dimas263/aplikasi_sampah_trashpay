...
import 'package:sampah/home/pencairan/danaPin.dart';
import 'package:sampah/main.dart';
import 'package:pin_code_fields/pin_code_fields.dart';

class PencairanDana extends StatefulWidget {

  @override
  _PencairanDanaState createState() => _PencairanDanaState();
}

class _PencairanDanaState extends State<PencairanDana> {
  final formKey = GlobalKey<FormState>();
  final no_dana = TextEditingController();
                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  if (value.isEmpty) {
                                    return 'No Dana tidak boleh kosong';
                                  }
                                  return null;
                                },
                              ),
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () async {
                                  if (formKey.currentState.validate()) {
                                    Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, duration: Duration(seconds: 1), child: PinCodeVerificationScreen(this.no_dana.text, this.jumlah_pencairan.text)));
                                    /*
                                          ...
                                          actions: [
                                            Center(
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    'Selamat, pencairan saldo Rp.'+jumlah_pencairan.text+',00 Ke Dana Berhasil',
                                                    style: GoogleFonts.montserrat(
                                                        color: HexColor('#000000'),
                                                        fontWeight: FontWeight.bold,
                                                        fontSize: 18
