...
class NonorganikPage extends StatefulWidget {

  @override
  _NonorganikPageState createState() => _NonorganikPageState();
}

class _NonorganikPageState extends State<NonorganikPage> {
  File _image;
  List _recognitions;
  bool _busy;
  double _imageWidth, _imageHeight;
  String sampah_recycle = "Nonorganik";
